...
|----------|--------|-----|-------|
| advice_consistency | 217.0 | 243.0 | 89.3% |
...
| BM-100 | scada_derived | SCADA记录液压站压力不足、液压油泄漏且制动响应迟缓... | SCAD:2/4, RISK:0/1, ADVI:1/3 | 0.649 | 0 | [scad] Partial match in advice text, graph: set(), domains: {'Blade', 'SCADA', '... |
...
- **Advice Consistency**: 89.3% keywords found
...
---
*Generated by beifeng/evals/run_benchmark.py at 2026-06-05 14:22:01*