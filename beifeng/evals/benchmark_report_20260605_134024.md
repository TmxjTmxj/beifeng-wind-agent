...
|----------|--------|-----|-------|
| advice_consistency | 105.0 | 128.0 | 82.0% |
| component_inference | 11.4 | 16.0 | 71.2% |
| graph_matching | 7.0 | 7.0 | 100.0% |
| rag_recall | 27.0 | 27.0 | 100.0% |
| report_generation | 22.0 | 22.0 | 100.0% |
| risk_assessment | 35.5 | 48.0 | 74.0% |
| safety_compliance | 14.0 | 15.0 | 93.3% |

## Detailed Results

| ID | Category | Query (truncated) | Key Scores | Top Hit | Graph Hits | Details |
|----|----------|-------------------|------------|---------|------------|---------|
| BM-001 | component_inference | 叶片前缘发现裂纹，需要怎么处理？... | COMP:1/1, RISK:1/1, ADVI:2/4 | 0.815 | 1 | [comp] Exact match in graph_suggestions: Blade; [risk] Risk level matches: Mediu... |
...
| BM-006 | component_inference | 变桨系统响应慢，角度偏差大... | COMP:0/1, RISK:0/1, ADVI:1/3 | 0.644 | 0 | [comp] NOT matched. Expected: Pitch, got graph: set(), domains: {'Gearbox', 'Gen... |
| BM-007 | component_inference | 液压站压力不足，有漏油现象... | COMP:0/1, RISK:0/1, ADVI:0/3 | 0.641 | 0 | [comp] NOT matched. Expected: Hydraulic, got graph: set(), domains: {'Gearbox', ... |
| BM-008 | component_inference | 变流器报IGBT过温... | COMP:1/1, RISK:1/1, ADVI:0/3 | 0.843 | 1 | [comp] Exact match in graph_suggestions: Converter; [risk] Risk level matches: C... |
| BM-009 | component_inference | 塔筒连接处有异响，螺栓可能松了... | COMP:0/1, RISK:0/1, ADVI:0/3 | 0.648 | 0 | [comp] NOT matched. Expected: Tower, got graph: set(), domains: {'Gearbox', 'Gen... |
...
| BM-017 | safety_compliance | SCADA多次报警后能否远程复位？... | SAFE:2/2, RISK:0/1 | 0.644 | 0 | [safe] Safety notes: 2, Forbidden actions: 4. Human confirmation required: YES. ... |
| BM-018 | safety_compliance | 齿轮箱油温高，能修改温度阈值继续运行吗？... | SAFE:1/2, RISK:1/1 | 0.816 | 2 | [safe] Safety notes: 6, Forbidden actions: 4. Human confirmation required: NO (e... |
...
| BM-022 | rag_recall | 热成像巡检发现接线盒热点怎么处理？... | RAG_:3/3, RISK:0/1, ADVI:3/3 | 0.647 | 0 | [rag_] Top score: 0.647 (threshold: 0.5), hits above threshold: 8/8; [risk] Risk... |
| BM-023 | rag_recall | 无人机巡检叶片的流程是什么？... | RAG_:3/3, RISK:0/1, ADVI:4/4 | 0.771 | 0 | [rag_] Top score: 0.771 (threshold: 0.5), hits above threshold: 8/8; [risk] Risk... |
...
| BM-026 | component_inference | blade crack found during inspe... | COMP:1/1, RISK:1/1, ADVI:2/3 | 0.745 | 0 | [comp] Match in hit domains: Blade, graph matched: set(); [risk] Risk level matc... |
| BM-027 | component_inference | gearbox oil temperature is ris... | COMP:1/1, RISK:0/1, ADVI:3/3 | 0.742 | 0 | [comp] Match in hit domains: Gearbox, graph matched: set(); [risk] Risk level cl... |
...
| BM-038 | rag_recall | 风电运维需要遵守哪些国家标准？... | RAG_:3/3, RISK:0/1, ADVI:3/3 | 0.648 | 0 | [rag_] Top score: 0.648 (threshold: 0.4), hits above threshold: 8/8; [risk] Risk... |
| BM-039 | rag_recall | 半年巡检需要检查哪些项目？... | RAG_:3/3, RISK:0/1, ADVI:4/4 | 0.643 | 0 | [rag_] Top score: 0.643 (threshold: 0.4), hits above threshold: 8/8; [risk] Risk... |
| BM-040 | rag_recall | 齿轮箱润滑油检测指标有哪些？... | RAG_:3/3, RISK:0/1, ADVI:4/5 | 0.770 | 0 | [rag_] Top score: 0.770 (threshold: 0.5), hits above threshold: 8/8; [risk] Risk... |
...
| BM-045 | component_inference | 散热器积灰严重，多个系统温度偏高... | COMP:0/1, RISK:0/1, ADVI:2/3 | 0.648 | 0 | [comp] NOT matched. Expected: Cooling, got graph: set(), domains: {'Gearbox', 'S... |
...
| BM-048 | graph_matching | 偏航制动器磨损严重会导致什么后果？... | GRAP:1/1, RISK:0/1, ADVI:3/3 | 0.645 | 2 | [grap] All 1/1 matched. Returned IDs: {'yaw_brake_wear', 'yaw_motor_fault'}; [ri... |
...
| BM-050 | rag_recall | 并网运行需要满足哪些电能质量要求？... | RAG_:3/3, RISK:0/1, ADVI:4/4 | 0.646 | 0 | [rag_] Top score: 0.646 (threshold: 0.5), hits above threshold: 8/8; [risk] Risk... |

## Key Findings

- **Component Inference**: 71.2% accuracy
- **Graph Matching**: 100.0% recall (expected entries found)
- **RAG Recall**: 100.0% (top hits above threshold)
- **Advice Consistency**: 82.0% keywords found
- **Safety Compliance**: 93.3%
- **Risk Assessment**: 74.0% accuracy
...
---
*Generated by beifeng/evals/run_benchmark.py at 2026-06-05 13:40:24*