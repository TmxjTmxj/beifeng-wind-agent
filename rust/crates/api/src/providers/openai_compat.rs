...
const DEEPSEEK_MAX_REQUEST_BODY_BYTES: usize = 104_857_600; // DeepSeek safety cap
...
mod tests {
    ...
    fn strip_routing_prefix_strips_kimi_provider_prefix() {
        ...
        assert_eq!(
            super::strip_routing_prefix("deepseek/deepseek-v4-flash"),
            "deepseek-v4-flash"
        );
    }

    #[test]
    fn sdu_deepseek_model_id_is_preserved_for_wire_format() {
        let request = MessageRequest {
            model: "SDU-AI/DeepSeek-V4-Flash".to_string(),
            max_tokens: 100,
            messages: vec![InputMessage::user_text("hello".to_string())],
            stream: false,
            ..Default::default()
        ...
        let payload = super::build_chat_completion_request_for_base_url(
            &request,
            OpenAiCompatConfig::deepseek(),
            super::DEFAULT_DEEPSEEK_BASE_URL,
        );

        assert_eq!(payload["model"], json!("SDU-AI/DeepSeek-V4-Flash"));
    }
}
