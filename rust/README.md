...
└── crates/
    ...
    ├── claw-analog/        # Simplified agent harness/reference implementation
    ├── claw-rag-service/   # BeiFeng Wind Knowledge Hub service
...
- **claw-analog** — simplified agent harness/reference surface; not the primary runtime entrypoint
- **claw-rag-service** — primary implementation of the BeiFeng Wind Knowledge Hub, including ingestion/search, fault analysis, advice, risk, and report support
